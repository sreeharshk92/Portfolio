...
const Sidebar = () => {
  return (
    <nav  className="bg-[#111111] fixed lg:right-0 md:right-0 bottom-0 flex lg:top-1/2 md:top-1/2 lg:transform md:transform lg:-translate-y-1/2 md:-translate-y-1/2  lg:px-6  md:px-6 lg:flex md:flex  lg:flex-col md:flex-col lg:items-center lg:justify-center md:items-center md:justify-center z-20">
